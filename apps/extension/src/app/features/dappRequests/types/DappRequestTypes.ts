...
export enum DappResponseType {
  ...
  OpenSidebarResponse = 'OpenSidebarResponse',
}
...
export const OpenSidebarRequestSchema = BaseDappRequestSchema.extend({
  type: z.literal(DappRequestType.OpenSidebar),
  tab: z.nativeEnum(HomeTabs).optional(),
})
export type OpenSidebarRequest = z.infer<typeof OpenSidebarRequestSchema>
...
export const OpenSidebarResponseSchema = BaseDappResponseSchema.extend({
  type: z.literal(DappResponseType.OpenSidebarResponse),
})
export type OpenSidebarResponse = z.infer<typeof OpenSidebarResponseSchema>
