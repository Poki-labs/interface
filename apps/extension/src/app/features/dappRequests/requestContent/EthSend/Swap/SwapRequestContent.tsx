import { DEFAULT_NATIVE_ADDRESS } from 'poki/src/features/chains/chainInfo'
...
import { useCurrencyInfo, useNativeCurrencyInfo } from 'poki/src/features/tokens/useCurrencyInfo'
import { TransactionType, TransactionTypeInfo } from 'poki/src/features/transactions/types/transactionDetails'
...
import { XSwapRequest } from 'src/app/features/dappRequests/types/Permit2Types'
...
// this is a special cased version of SwapRequestContent used for PokiX swaps
export function XSwapRequestContent({ typedData }: { typedData: XSwapRequest }): JSX.Element {
  const { defaultChainId } = useEnabledChains()
