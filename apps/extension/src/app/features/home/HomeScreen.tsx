...
import { useSelectAddressHasNotifications } from 'poki/src/features/notifications/hooks'
import { setNotificationStatus } from 'poki/src/features/notifications/slice'
...
export const HomeScreen = memo(function _HomeScreen(): JSX.Element {
  ...
  const [tagTokenModalOpen, setTagTokenModalOpen] = useState(false)
        ...
        <Flex backgroundColor="$surface1" gap="$spacing12" width="100%">
          ...
          <Flex grow gap="$spacing8">
            ...
            <Flex flex={1} width="100%">
              <Flex width="100%" row justifyContent="space-between" alignItems="center">
                ...
                {selectedTab === HomeTabs.Tokens ? (
                  <TouchableArea
                    alignItems="center"
                    flexDirection="row"
                    gap="$spacing4"
                    p="$spacing2"
                    onPress={() => setTagTokenModalOpen(true)}
                  >
                    <Plus size={18} />
                  </TouchableArea>
                ) : null}
                ...
                <TokenSelectorModal
                  isModalOpen={tagTokenModalOpen}
                  currencyField={CurrencyField.INPUT}
                  flow={TokenSelectorFlow.Tag}
                  variation={TokenSelectorVariation.BalancesOnly}
                  onClose={() => setTagTokenModalOpen(false)}
                  title={t('common.manageToken.label')}
                />
              </Flex>
