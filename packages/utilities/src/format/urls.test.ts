// Copied from https://github.com/Poki/interface/blob/main/src/utils/uriToHttp.test.ts
...
describe(uriToHttpUrls, () => {
  ...
  it('returns ipns gateways for ipns:// urls', () => {
    expect(uriToHttpUrls('ipns://app.pokiwallet.com')).toEqual([
      'https://ipfs.io/ipns/app.pokiwallet.com/',
      'https://hardbin.com/ipns/app.pokiwallet.com/',
    ])
  })
