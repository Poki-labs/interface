...
const HASH_TO_FUNCTION_SIGNATURE: Record<string, string> = {
  ...
  d3487997: 'pokiV3MintCallback(uint256,uint256,bytes)',
  ...
  fa461e33: 'pokiV3SwapCallback(int256,int256,bytes)',
  ...
  c31c9c07: 'swapRouter()',
  e9cbafb0: 'pokiV3FlashCallback(uint256,uint256,bytes)',
  ...
  '10d1e85c': 'pokiV2Call(address,uint256,uint256,bytes)',
