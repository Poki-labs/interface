...
export enum InterfaceElementName {
  ...
  POKI_WALLET_BANNER_DOWNLOAD_BUTTON = 'poki-wallet-banner-download-button',
  POKI_WALLET_CONNECTOR = 'poki-wallet-connector',
  POKI_WALLET_LANDING_PAGE_DOWNLOAD_BUTTON = 'poki-wallet-landing-page-download-button',
  POKI_WALLET_MODAL_DOWNLOAD_BUTTON = 'poki-wallet-modal-download-button',
  POKI_WALLET_NAVBAR_MENU_DOWNLOAD_BUTTON = 'poki-wallet-navbar-menu-download-button',
