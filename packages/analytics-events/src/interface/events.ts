...
export enum InterfaceEventName {
  ...
  POKI_WALLET_APP_DOWNLOAD_OPENED = 'Poki Wallet App Download Opened',
  POKI_WALLET_MICROSITE_OPENED = 'Poki Wallet Microsite Opened',
  UNIWALLET_CONNECT_MODAL_OPENED = 'Poki wallet modal opened',
