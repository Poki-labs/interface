...
const { shared: restrictedImports } = require('@poki/eslint-config/restrictedImports')
...
const noRestrictedImports = [
  ...
  {
    name: 'poki/src/features/settings/selectors',
    importNames: ['selectIsTestnetModeEnabled'],
    message: 'Use `useEnabledChains` instead.',
  },
  {
    name: 'poki/src/data/graphql/poki-data-api/__generated__/types-and-hooks',
  ...
  },
  {
    ...
    message: 'Use our internal `BottomSheetTextInput` wrapper from `/poki/src/components/modals/Modal`.',
  },
  {
  ...
  {
    name: 'statsig-react',
    message: 'Import from internal module poki/src/features/gating instead',
  },
  {
  ...
  {
    name: '@poki/analytics',
    message: "Did you mean to import from 'poki/src/features/telemetry/send'?",
  },
