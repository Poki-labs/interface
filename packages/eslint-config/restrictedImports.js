  ...
  paths: [
    {
      ...
      message: "Please use the Trace in 'poki/src/features/telemetry/Trace' for app level usage!",
    },
    {
      name: 'utilities/src/telemetry/analytics/analytics',
      message:
        'Please only use this for initialization, tests, flushing, and internal usage. Otherwise use `packages/poki/src/features/telemetry`',
    },
    {
      name: '@poki/analytics',
      message: 'This is for internal use only. Please use `packages/poki/src/features/telemetry`',
    },
    {
    ...
    {
      name: 'poki/src/features/dataApi/balances',
    ...
    {
      name: 'poki/src/features/fiatCurrency/conversion',
      importNames: ['useFiatConverter'],
      message: 'Use via `useLocalizationContext` instead.',
    },
    {
      name: 'poki/src/features/language/formatter',
    ...
    {
      name: 'poki/src/features/chains/chainInfo',
      importNames: ['UNIVERSE_CHAIN_INFO'],
      message: 'Use useChainInfo or helpers in packages/poki/src/features/chains/utils.ts when possible!',
    },
  ],
  patterns: [
    {
...
exports.crossPlatform = {
  paths: [
    ...
    },
    {
      ...
      message:
        'Please import logos directly from their respective files, e.g. `ui/src/components/logos/SpecificLogo`. This is to avoid importing the entire logos folder when only some logos are needed, which increases bundle size',
    },
    {
      name: 'ui/src/components/modal/AdaptiveWebModal',
      message:
        'Please import Modal from `poki/src/components/modals/Modal` instead. Modal uses AdaptiveWebModal under the hood but has extra logic for handling animation, mounting, and dismounting.',
    },
  ],
  patterns: [
