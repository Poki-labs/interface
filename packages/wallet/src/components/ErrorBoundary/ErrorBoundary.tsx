...
import { pushNotification, resetNotifications } from 'poki/src/features/notifications/slice'
...
export const ErrorBoundary = ({
  ...
  // We want to temporary disable non global error boundaries until https://linear.app/poki/issue/WALL-4461 is done
