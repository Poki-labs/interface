...
import { NotificationState, pushNotification } from 'poki/src/features/notifications/slice'
...
import { finalizedTransactionAction } from 'poki/src/test/fixtures'
...
describe(pushTransactionNotification, () => {
  ...
  it('Handles approve transactions', () => {
    const approveTypeInfo: ApproveTransactionInfo = {
      ...
      tokenAddress: '0xPokiToken',
      spender: '0xPokiDeployer',
    }
