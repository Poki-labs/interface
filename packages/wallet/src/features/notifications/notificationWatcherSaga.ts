...
import { STALE_TRANSACTION_TIME_MS } from 'poki/src/features/notifications/constants'
import { makeSelectAddressNotifications } from 'poki/src/features/notifications/selectors'
import { pushNotification } from 'poki/src/features/notifications/slice'
import { AppNotification, AppNotificationType } from 'poki/src/features/notifications/types'
...
import { WalletConnectEvent } from 'poki/src/types/walletConnect'
...
export function* pushTransactionNotification(action: ReturnType<typeof finalizeTransaction>) {
  ...
  const existingNotifications = yield* select((state: PokiState) =>
