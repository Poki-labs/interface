import { AmountInput } from 'poki/src/components/CurrencyInputPanel/AmountInput'
...
// import { ParsedWarnings, WarningLabel } from 'poki/src/components/modals/WarningModal/types'
...
import { useTokenAndFiatDisplayAmounts } from 'poki/src/features/transactions/hooks/useTokenAndFiatDisplayAmounts'
...
export function SendAmountInput({
  ...
  // We ignore this specific warning type because we have dedicated UI for this in the review button
  // const warning = insufficientGasFunds ? undefined : formScreenWarning
  const subTextValue = tokenOrFiatEquivalentAmount
  const subTextValueColor = '$neutral2'
  const inputColor = !value ? '$neutral3' : '$neutral1'
      ...
      <Flex row alignItems="center" height={MAX_INPUT_FONT_SIZE} justifyContent="center" overflow="hidden">
        ...
        {currencyInfo ? (
          <AmountInput
            ...
            fontFamily="$heading"
            fontSize={fontSize}
            maxDecimals={currencyInfo.tokenDecimal}
