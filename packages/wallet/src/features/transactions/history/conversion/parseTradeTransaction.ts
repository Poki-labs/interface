...
import { TokenStandard, TransactionDirection } from 'poki/src/data/graphql/poki-data-api/__generated__/types-and-hooks'
...
import { buildCurrencyId, buildNativeCurrencyId, buildWrappedNativeCurrencyId } from 'poki/src/utils/currencyId'
import {
...
export default function parseTradeTransaction(
  ...
  // ignore PokiX transactions for now
