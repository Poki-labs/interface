...
import { ActionSheetModalContent, MenuItemProp } from 'poki/src/components/modals/ActionSheetModal'
import { Modal } from 'poki/src/components/modals/Modal'
import { pokiWalletUrls } from 'poki/src/constants/urls'
import { FORMAT_DATE_LONG, useFormattedDate } from 'poki/src/features/language/localizedDayjs'
...
export async function openSupportLink(transactionDetails: TransactionDetails): Promise<void> {
  ...
  switch (transactionDetails.typeInfo.type) {
    ...
    default:
      ...
      params.append('tf_7005922218125', isWeb ? 'poki_extension_issue' : 'uw_ios_app') // Report Type Dropdown
      ...
      return openUri(pokiWalletUrls.helpRequestUrl + '?' + params.toString()).catch((e) =>
