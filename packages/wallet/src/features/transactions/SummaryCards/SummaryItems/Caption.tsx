...
import {
  ...
  FORMAT_TIME_SHORT,
  useLocalizedDayjs,
} from 'poki/src/features/language/localizedDayjs'
import {
  NFTTradeType,
  TransactionDetails,
  TransactionStatus,
...
export function Caption(transaction: IcExplorerAddressTransaction) {
  switch (transaction.op) {
    case 'approve':
      return <ApproveSummaryItem transaction={transaction} />
  }
