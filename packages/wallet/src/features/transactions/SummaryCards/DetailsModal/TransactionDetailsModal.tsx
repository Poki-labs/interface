...
import { FORMAT_DATE_TIME_MEDIUM, useFormattedDateTime } from 'poki/src/features/language/localizedDayjs'
...
import { AnglesDownUp, Ellipsis, PokiX, SortVertical } from 'ui/src/components/icons'
        ...
        <Flex flexDirection="column">
          <Flex centered row gap="$spacing4" justifyContent="flex-start">
            {(transactionDetails.routing === Routing.DUTCH_V2 ||
              transactionDetails.routing === Routing.DUTCH_LIMIT) && <PokiX size="$icon.16" />}
