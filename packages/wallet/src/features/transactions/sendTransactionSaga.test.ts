...
import { addTransaction, finalizeTransaction, updateTransaction } from 'poki/src/features/transactions/slice'
import {
  TransactionDetails,
  TransactionOriginType,
  TransactionStatus,
} from 'poki/src/features/transactions/types/transactionDetails'
import { getTxFixtures } from 'poki/src/test/fixtures'
...
jest.mock('poki/src/features/gating/sdk/statsig', () => ({
  Statsig: {
