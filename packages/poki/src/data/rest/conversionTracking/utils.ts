...
import { PlatformIdType } from 'poki/src/data/rest/conversionTracking/types'
...
export const getExternalConversionLeadsCookie = (): { key: PlatformIdType; value: string } | void => {
  // Note: External cookie will be set from other poki subdomains (e.g. wallet.pokiwallet.com)
