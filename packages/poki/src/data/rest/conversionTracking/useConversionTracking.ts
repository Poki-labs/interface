...
} from 'poki/src/data/rest/conversionTracking/constants'
import { buildProxyRequest } from 'poki/src/data/rest/conversionTracking/tracking'
import { ConversionLead, PlatformIdType, TrackConversionArgs } from 'poki/src/data/rest/conversionTracking/types'
import { useConversionProxy } from 'poki/src/data/rest/conversionTracking/useConversionProxy'
import { getExternalConversionLeadsCookie } from 'poki/src/data/rest/conversionTracking/utils'
import { FeatureFlags } from 'poki/src/features/gating/flags'
import { useFeatureFlag } from 'poki/src/features/gating/hooks'
import { PokiEventName } from 'poki/src/features/telemetry/constants'
  ...
  const trackConversion = useCallback(
    async ({ platformIdType, eventId, eventName }: TrackConversionArgs) => {
      ...
      try {
        ...
        sendAnalyticsEvent(PokiEventName.ConversionEventSubmitted, {
          id: lead.id,
          eventId,
          eventName,
          platformIdType,
