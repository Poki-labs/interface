...
import { TRADING_API_CACHE_KEY, fetchSwappableTokens } from 'poki/src/data/apiClients/tradingApi/TradingApiClient'
...
const swappableTokensQueryKey = (params?: SwappableTokensParams): QueryKey => {
  return [TRADING_API_CACHE_KEY, pokiWalletUrls.tradingApiPaths.swappableTokens, params]
}
