import { NetworkLogo, TransactionSummaryNetworkLogo } from 'poki/src/components/CurrencyLogo/NetworkLogo'
import { UniverseChainId } from 'poki/src/features/chains/types'
import { render } from 'poki/src/test/test-utils'

jest.mock('poki/src/features/chains/chainInfo', () => {
  const actualChains = jest.requireActual('poki/src/features/chains/chainInfo')
...
describe('NetworkLogo', () => {
  const ACTUAL_CHAIN_INFO = jest.requireActual('poki/src/features/chains/chainInfo').UNIVERSE_CHAIN_INFO
