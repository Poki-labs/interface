...
} from 'poki/src/components/ConfirmSwapModal/steps/Approve'
import { LPTransactionStepRow } from 'poki/src/components/ConfirmSwapModal/steps/LP'
import { Permit2SignatureStepRow } from 'poki/src/components/ConfirmSwapModal/steps/Permit'
import { SwapTransactionStepRow } from 'poki/src/components/ConfirmSwapModal/steps/Swap'
import { WrapTransactionStepRow } from 'poki/src/components/ConfirmSwapModal/steps/Wrap'
import { StepStatus } from 'poki/src/components/ConfirmSwapModal/types'
import { TransactionStep, TransactionStepType } from 'poki/src/features/transactions/swap/types/steps'
...
function Step({ step, status }: { step: TransactionStep; status: StepStatus }): JSX.Element {
  switch (step.type) {
    ...
    case TransactionStepType.PokiXSignature:
