...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from 'poki/src/sdk-core'
...
/**
 * Represents the Poki V3 SwapRouter, and has static methods for helping execute trades.
 */
