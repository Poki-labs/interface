...
const createMockPokiXOrder = (token: string): DutchOrderInfoV2 => ({
  chainId: 1,
...
export const createMockPokiXQuote = (token: string): DutchQuoteV2 => ({
  encodedOrder: '0x000',
  orderId: '0xbbb',
  orderInfo: createMockPokiXOrder(token),
...
export const createMockPokiXTrade = (inputCurrency: Token, outputCurrency: Token): PokiXV2Trade => {
  return new PokiXV2Trade({
    ...
    quote: {
      ...
      quote: createMockPokiXQuote(inputCurrency.address),
