import { Currency, Token, WETH9 } from 'poki/src/sdk-core'
...
import { buildCurrencyInfo } from 'poki/src/features/dataApi/utils'
...
function getTokenLogoURI(chainId: UniverseChainId, address: string): ImageSourcePropType | string | undefined {
  ...
  return networkName
    ? `https://raw.githubusercontent.com/Poki/assets/master/blockchains/${networkName}/assets/${address}/logo.png`
    : undefined
}
