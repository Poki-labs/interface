...
import { useConnector } from 'poki/src/contexts/PokiContext'
import { useFeatureFlaggedChainIds } from 'poki/src/features/chains/hooks/useFeatureFlaggedChainIds'
import { useOrderedChainIds } from 'poki/src/features/chains/hooks/useOrderedChainIds'
import { ALL_CHAIN_IDS, EnabledChainsInfo, GqlChainId, UniverseChainId } from 'poki/src/features/chains/types'
import { getEnabledChains } from 'poki/src/features/chains/utils'
import { selectIsTestnetModeEnabled } from 'poki/src/features/settings/selectors'
import { WalletConnectConnector } from 'poki/src/features/web3/walletConnect'
...
function useConnectorSupportedChains(connector?: Connector): UniverseChainId[] {
  ...
  return useMemo(() => {
    switch (connector?.type) {
      case CONNECTION_PROVIDER_IDS.POKI_WALLET_CONNECT_CONNECTOR_ID:
