import { CurrencyAmount, ChainId as PokiSDKChainId, Token } from 'poki/src/sdk-core'
// eslint-disable-next-line no-restricted-imports
import { Chain as BackendChainId } from 'poki/src/data/graphql/poki-data-api/__generated__/types-and-hooks'
...
export enum UniverseChainId {
  Mainnet = PokiSDKChainId.MAINNET,
  ArbitrumOne = PokiSDKChainId.ARBITRUM_ONE,
  Avalanche = PokiSDKChainId.AVALANCHE,
  Base = PokiSDKChainId.BASE,
  Blast = PokiSDKChainId.BLAST,
  Bnb = PokiSDKChainId.BNB,
  Celo = PokiSDKChainId.CELO,
  MonadTestnet = PokiSDKChainId.MONAD_TESTNET,
  Optimism = PokiSDKChainId.OPTIMISM,
  Polygon = PokiSDKChainId.POLYGON,
  Sepolia = PokiSDKChainId.SEPOLIA,
  Unichain = PokiSDKChainId.UNICHAIN,
  UnichainSepolia = PokiSDKChainId.UNICHAIN_SEPOLIA,
  WorldChain = PokiSDKChainId.WORLDCHAIN,
  Zksync = PokiSDKChainId.ZKSYNC,
  Zora = PokiSDKChainId.ZORA,
}
...
export interface UniverseChainInfo extends WagmiChain {
  ...
  readonly sdkId: PokiSDKChainId
  readonly assetRepoNetworkName: string | undefined // Name used to index the network on this repo: https://github.com/Poki/assets/
