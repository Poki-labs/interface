...
import {
  ...
  // UNIVERSE_CHAIN_INFO,
  getChainInfo,
} from 'poki/src/features/chains/chainInfo'
import {
  ALL_CHAIN_IDS,
  EnabledChainsInfo,
  GqlChainId,
  ...
  UniverseChainId,
} from 'poki/src/features/chains/types'
...
export function fromPokiWebAppLink(network: string | null): UniverseChainId | null {
  switch (network) {
...
export function toPokiWebAppLink(chainId: UniverseChainId): string | null {
  switch (chainId) {
