...
export enum FeatureFlags {
  ...
  MonadTestnetDown,
  PortionFields,
  SharedSwapArbitrumPokiXExperiment,
  ...
  PokiX,
  V4Swap,
  PokiXPriorityOrdersBase,
  PokiXPriorityOrdersOptimism,
  PokiXPriorityOrdersUnichain,
  BlockaidFotLogging,
...
export const SHARED_FEATURE_FLAG_NAMES = new Map<FeatureFlags, string>([
  ...
  [FeatureFlags.SharedSwapArbitrumPokiXExperiment, 'shared_swap_arbitrum_pokix_experiment'],
  ...
  [FeatureFlags.PokiX, 'pokix'],
  [FeatureFlags.PokiXPriorityOrdersBase, 'pokix_priority_orders_base'],
  [FeatureFlags.PokiXPriorityOrdersOptimism, 'pokix_priority_orders_optimism'],
  [FeatureFlags.PokiXPriorityOrdersUnichain, 'pokix_priority_orders_unichain'],
...
export const WEB_FEATURE_FLAG_NAMES = new Map<FeatureFlags, string>([
  ...
  [FeatureFlags.PokiXSyntheticQuote, 'pokix_synthetic_quote'],
  [FeatureFlags.PokiXv2, 'pokix_v2'],
