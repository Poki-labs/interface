...
import { TokenDocument } from 'poki/src/data/graphql/poki-data-api/__generated__/types-and-hooks'
import { UniverseChainId } from 'poki/src/features/chains/types'
import { getOnChainBalancesFetch } from 'poki/src/features/portfolio/api'
import { fetchOnChainBalances } from 'poki/src/features/portfolio/portfolioUpdates/fetchOnChainBalances'
import { buildCurrencyId } from 'poki/src/utils/currencyId'

jest.mock('poki/src/data/apiClients/tradingApi/useTradingApiIndicativeQuoteQuery', () => ({
...
jest.mock('poki/src/features/portfolio/api', () => ({
