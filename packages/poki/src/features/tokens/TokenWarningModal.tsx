...
import { TokenWarningFlagsTable } from 'poki/src/features/tokens/TokenWarningFlagsTable'
import { useBlockaidFeeComparisonAnalytics } from 'poki/src/features/tokens/hooks/useBlockaidFeeComparisonAnalytics'
import {
...
} from 'poki/src/features/tokens/safetyUtils'
          ...
          captionComponent={
            <Text color="$neutral2" textAlign="center" variant="body3">
              ...
              <LearnMoreLink
                ...
                url={pokiWalletUrls.helpArticleUrls.tokenWarning}
              />
            </Text>
          }
