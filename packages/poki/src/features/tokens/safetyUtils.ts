...
import { AttackType, CurrencyInfo, TokenList } from 'poki/src/features/dataApi/types'
import { useLocalizationContext } from 'poki/src/features/language/LocalizationContext'
import { Currency, NativeCurrency } from 'poki/src/sdk-core'
  ...
  switch (tokenProtectionWarning) {
    ...
    case TokenProtectionWarning.FotLow: {
      ...
      return (
        ...
        ' ' +
        t('token.safety.fees.pokiLabsDoesNotReceive')
      )
    }
    case TokenProtectionWarning.NonDefault:
