import { useUrlContext } from 'poki/src/contexts/UrlContext'
...
import { useCurrentLocale } from 'poki/src/features/language/hooks'
...
export function useAppFiatCurrency(): FiatCurrency {
  const storeFiatCurrency = useSelector((state: PokiState) => state.userSettings.currentCurrency)
