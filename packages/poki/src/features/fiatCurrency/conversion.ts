import { Currency } from 'poki/src/data/graphql/poki-data-api/__generated__/types-and-hooks'
import { FiatCurrency } from 'poki/src/features/fiatCurrency/constants'
import { getFiatCurrencyCode, useAppFiatCurrency } from 'poki/src/features/fiatCurrency/hooks'
...
export function useFiatConverter({
  ...
  const conversionCurrency = undefined
