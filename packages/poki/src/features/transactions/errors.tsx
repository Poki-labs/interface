  ...
  switch (error.step.type) {
    case TransactionStepType.WrapTransaction:
      return {
        ...
        supportArticleURL: pokiWalletUrls.helpArticleUrls.wethExplainer,
      }
    ...
    case TransactionStepType.SwapTransactionAsync:
      return {
        ...
        supportArticleURL: pokiWalletUrls.helpArticleUrls.transactionFailure,
      }
    case TransactionStepType.PokiXSignature:
      if (error.isBackendRejection) {
        return {
          title: t('common.swap.failed'),
          message: t('swap.fail.pokiX'),
          supportArticleURL: pokiWalletUrls.helpArticleUrls.pokiXFailure,
        }
      }
      return {
        title: t('common.swap.failed'),
    ...
    case TransactionStepType.Permit2Signature:
      return {
        ...
        supportArticleURL: pokiWalletUrls.helpArticleUrls.approvalsExplainer,
      }
    ...
    case TransactionStepType.TokenRevocationTransaction:
      return {
        ...
        supportArticleURL: pokiWalletUrls.helpArticleUrls.revokeExplainer,
      }
    default:
      return {
        title: t('common.unknownError.error'),
