import { useCheckApprovalQuery } from 'poki/src/data/apiClients/tradingApi/useCheckApprovalQuery'
import { ApprovalRequest, Routing } from 'poki/src/data/tradingApi/__generated__/index'
import { AccountMeta } from 'poki/src/features/accounts/types'
import { UniverseChainId } from 'poki/src/features/chains/types'
import { convertGasFeeToDisplayValue, useActiveGasStrategy, useShadowGasStrategies } from 'poki/src/features/gas/hooks'
...
export function useTokenApprovalInfo(params: TokenApprovalInfoParams): TokenApprovalInfo & TokenApprovalGasInfo {
  ...
  const inputWillBeWrapped = routing && isPokiX({ routing })
