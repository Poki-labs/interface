...
} from 'poki/src/features/transactions/swap/hooks/useTokenApprovalInfo'
...
import { CurrencyAmount, Token } from 'poki/src/sdk-core'
import { logger } from 'utilities/src/logger/logger'

jest.mock('poki/src/data/apiClients/tradingApi/useCheckApprovalQuery')
