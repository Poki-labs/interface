...
import { DutchQuoteV2, DutchQuoteV3, PriorityQuote } from 'poki/src/data/tradingApi/__generated__'
...
export type MigratePositionSteps =
  | Permit2SignatureStep
...
// PokiX
export interface PokiXSignatureStep extends SignTypedDataStepFields {
  type: TransactionStepType.PokiXSignature
  deadline: number
  quote: DutchQuoteV2 | DutchQuoteV3 | PriorityQuote
}

export type PokiXSwapFlow = {
  wrap?: WrapTransactionStep
  revocation?: TokenRevocationTransactionStep
  approval?: TokenApprovalTransactionStep
  signOrder: PokiXSignatureStep
}
