import { BottomSheetTextInput } from 'poki/src/components/modals/Modal'
...
} from 'poki/src/constants/transactions'
...
import { BridgeTrade, TradeWithSlippage } from 'poki/src/features/transactions/swap/types/trade'
import { slippageToleranceToPercent } from 'poki/src/features/transactions/swap/utils/format'
import { getSlippageWarningColor } from 'poki/src/features/transactions/swap/utils/styleHelpers'
  ...
  Screen() {
    ...
    return (
      <Flex centered gap="$spacing16">
        ...
        {!isBridgeTrade && <LearnMoreLink url={pokiWalletUrls.helpArticleUrls.swapSlippage} />}
        <Flex gap="$spacing12">
