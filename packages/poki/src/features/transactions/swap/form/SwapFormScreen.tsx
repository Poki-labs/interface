...
import { CurrencyInputPanel, CurrencyInputPanelRef } from 'poki/src/components/CurrencyInputPanel/CurrencyInputPanel'
import { WarningSeverity } from 'poki/src/components/modals/WarningModal/types'
import { MAX_FIAT_INPUT_DECIMALS } from 'poki/src/constants/transactions'
import { usePrefetchSwappableTokens } from 'poki/src/data/apiClients/tradingApi/useTradingApiSwappableTokensQuery'
...
import { getTokenWarningSeverity } from 'poki/src/features/tokens/safetyUtils'
import {
  DecimalPadCalculatedSpaceId,
  DecimalPadCalculateSpace,
  DecimalPadInput,
  DecimalPadInputRef,
} from 'poki/src/features/transactions/DecimalPadInput/DecimalPadInput'
...
import { GasAndWarningRows } from 'poki/src/features/transactions/swap/form/footer/GasAndWarningRows'
import { SwapArrowButton } from 'poki/src/features/transactions/swap/form/SwapArrowButton'
import { SwapFormButton } from 'poki/src/features/transactions/swap/form/SwapFormButton'
import { SwapFormHeader } from 'poki/src/features/transactions/swap/form/SwapFormHeader'
import { SwapFormSettings } from 'poki/src/features/transactions/swap/form/SwapFormSettings'
import { SwapTokenSelector } from 'poki/src/features/transactions/swap/form/SwapTokenSelector'
import { useExactOutputWillFail } from 'poki/src/features/transactions/swap/hooks/useExactOutputWillFail'
import { useFeeOnTransferAmounts } from 'poki/src/features/transactions/swap/hooks/useFeeOnTransferAmount'
...
import { useSyncFiatAndTokenAmountUpdater } from 'poki/src/features/transactions/swap/hooks/useSyncFiatAndTokenAmountUpdater'
...
import { PriceImpactRow } from 'poki/src/features/transactions/swap/review/SwapDetails'
...
import { BridgeTrade } from 'poki/src/features/transactions/swap/types/trade'
import { WrapCallback } from 'poki/src/features/transactions/swap/types/wrapCallback'
...
import { isWrapAction } from 'poki/src/features/transactions/swap/utils/wrap'
...
function ExpandableRows({ isBridge }: { isBridge?: boolean }): JSX.Element | null {
  ...
  const pokiXGasBreakdown = isPokiX(swapTxContext) ? swapTxContext.gasFeeBreakdown : undefined
