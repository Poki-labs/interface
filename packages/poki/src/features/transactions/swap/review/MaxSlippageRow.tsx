...
import { BridgeTrade, IndicativeTrade, TradeWithSlippage } from 'poki/src/features/transactions/swap/types/trade'
...
export function SlippageWarningContent({
      ...
      <Text color="$neutral2" textAlign={isWeb ? 'left' : 'center'} variant={isWeb ? 'body4' : 'body2'}>
        ...
        {isWeb && (
          <Flex display="inline-flex">
            <LearnMoreLink url={pokiWalletUrls.helpArticleUrls.swapSlippage} textVariant="body4" textColor="white" />
          </Flex>
        )}
      </Text>
  ...
  return (
    <WarningInfo
      infoButton={isMobileApp ? <LearnMoreLink url={pokiWalletUrls.helpArticleUrls.swapSlippage} /> : null}
      modalProps={{
