import { Warning, WarningSeverity } from 'poki/src/components/modals/WarningModal/types'
...
import { SWAP_BUTTON_TEXT_VARIANT } from 'poki/src/features/transactions/swap/form/SwapFormButton'
    ...
    case showPokiXSubmittingUI: {
      return (
        <DeprecatedButton
          ...
          opacity={1} // For PokiX submitting UI, opacity should be full despite disabled state
          size={size}
        >
          <PokiXSubmittingText />
        </DeprecatedButton>
...
function PokiXSubmittingText(): JSX.Element {
  const { t } = useTranslation()
