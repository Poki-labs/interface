import { ProgressIndicator } from 'poki/src/components/ConfirmSwapModal/ProgressIndicator'
...
} from 'poki/src/features/transactions/TransactionDetails/utils'
import {
  TransactionModalFooterContainer,
  TransactionModalInnerContainer,
} from 'poki/src/features/transactions/TransactionModal/TransactionModal'
import {
  TransactionScreen,
...
import { useAcceptedTrade } from 'poki/src/features/transactions/swap/hooks/useAcceptedTrade'
...
import { SubmitSwapButton } from 'poki/src/features/transactions/swap/review/SubmitSwapButton'
import { SwapDetails } from 'poki/src/features/transactions/swap/review/SwapDetails'
import { SwapErrorScreen } from 'poki/src/features/transactions/swap/review/SwapErrorScreen'
import { TransactionAmountsReview } from 'poki/src/features/transactions/swap/review/TransactionAmountsReview'
import { TransactionStep } from 'poki/src/features/transactions/swap/types/steps'
import { SwapCallback } from 'poki/src/features/transactions/swap/types/swapCallback'
import { isValidSwapTxContext } from 'poki/src/features/transactions/swap/types/swapTxAndGasInfo'
...
import { interruptTransactionFlow } from 'poki/src/utils/saga'
...
export function SwapReviewScreen(props: SwapReviewScreenProps): JSX.Element | null {
  ...
  const onWrap = useMemo(() => {
    ...
    const txRequest = isPokiX(swapTxContext) ? undefined : swapTxContext.txRequest
  ...
  const showPokiXSubmittingUI = isPokiX(swapTxContext) && isSubmitting && !isInterface
        ...
        <TransactionModalFooterContainer>
          <Flex row gap="$spacing8">
            ...
            <SubmitSwapButton
              ...
              showPokiXSubmittingUI={showPokiXSubmittingUI}
              warning={reviewScreenWarning?.warning}
