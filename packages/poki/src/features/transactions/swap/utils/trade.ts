...
import { NullablePermit, Permit } from 'poki/src/data/tradingApi/__generated__/index'
...
import { ACROSS_DAPP_INFO, isBridge, isClassic, isPokiX } from 'poki/src/features/transactions/swap/utils/routing'
...
import { Currency, CurrencyAmount, Fraction, Percent, TradeType } from 'poki/src/sdk-core'
...
export function tradeToTransactionInfo(
  ...
  // PokiX trades wrap native input before swapping
  const inputCurrency = isPokiX(trade) ? trade.inputAmount.currency.wrapped : trade.inputAmount.currency
 ...
 *
 * Example:
 * Swap: 1.50 ETH = 367.351 POKI
 * ETH USD Price: $4,839.93, POKI USD Price: $4,755.47
 * Corrected Rate Calculation:
 * 1 POKI USD Rate = 4,755.47 / 367.351 = 12.94 USD
