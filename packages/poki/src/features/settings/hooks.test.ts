...
} from 'poki/src/features/settings/hooks'
import { selectIsTestnetModeEnabled, selectWalletHideSpamTokensSetting } from 'poki/src/features/settings/selectors'
...
jest.mock('poki/src/features/settings/selectors', () => ({
