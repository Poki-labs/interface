import { SERVICE_PROVIDER_ICON_BORDER_RADIUS, ServiceProviderLogoStyles } from 'poki/src/features/fiatOnRamp/constants'
import { useAppInsets } from 'poki/src/hooks/useAppInsets'
import { useTranslation } from 'react-i18next'
import { Image, ImageBackground, StyleSheet } from 'react-native'
import { FadeIn, FadeOut } from 'react-native-reanimated'
import { Flex, Text, useIsDarkMode } from 'ui/src'
import { FOR_CONNECTING_BACKGROUND_DARK, FOR_CONNECTING_BACKGROUND_LIGHT, POKI_LOGO_LARGE } from 'ui/src/assets'
    ...
    >
      <AnimatedFlex centered grow entering={FadeIn} exiting={FadeOut} style={{ marginBottom: insets.bottom }}>
        <Flex row gap="$spacing16" pb="$spacing16">
          <Flex alignItems="center" justifyContent="center" style={styles.pokiLogoWrapper}>
            <Image source={POKI_LOGO_LARGE} style={styles.logo} />
          </Flex>
          {serviceProviderLogo}
        </Flex>
