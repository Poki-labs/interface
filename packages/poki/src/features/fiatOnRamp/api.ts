...
import { FOR_API_HEADERS } from 'poki/src/features/fiatOnRamp/constants'
import {
...
import { transformPaymentMethods } from 'poki/src/features/fiatOnRamp/utils'

export const fiatOnRampAggregatorApi = createApi({
  reducerPath: 'fiatOnRampAggregatorApi-poki',
  baseQuery: fetchBaseQuery({
    baseUrl: pokiWalletUrls.forApiUrl,
