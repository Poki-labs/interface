...
export const POKI_LOGO = require('./logos/png/Poki-logo.png')
export const POKI_LOGO_LARGE = require('./logos/png/Poki-logo.png')
export const POKI_MONO_LOGO_LARGE = require('./logos/png/Poki-logo.png')
export const POKI_APP_ICON = require('./logos/png/Poki-logo.png')
export const EXTENSION_LOADING_BACKGROUND = require('./logos/png/extension-loading.png')
